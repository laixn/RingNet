...
| Data1 | `03_singlecell_matrix_data1.csv` | Yes | Provides continuous values for each cell group. |
| Data2 | `04_singlecell_matrix_data2.csv` | Yes | Provides continuous values for each cell group. |
| Data3 | `05_singlecell_data3.csv` | Yes | Provides integer values for each cell group. |
| Data4 | `06_singlecell_data4.csv` | Yes | Provides integer values for each cell group. |
