...
RingNet is a tool for visualizing multimodal data in networks (https://fip-128-214-252-149.kaj.poutavm.fi/cmt_figures/). It supports the creation of networks with one or more data sets. In addition to the general template, we provide templates for visualizing gene-gene interaction networks, patient similarity networks, and single-cell networks. You can find more information about preparing the CSV files for visualization in the tutorials. If you already have a JSON file generated by RingNet for your network, you can use it directly for visualization without rerunning the program. For any bug or feedback, please contact us via RingNet's github reporsitory https://github.com/laixn/RingNet.
